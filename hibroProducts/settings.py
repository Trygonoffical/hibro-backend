"""
Django settings for hibroProducts project.
...
SECRET_KEY = 'django-insecure-f@t*&f@f+0hiz!ej=t8^g$ty=vx_+^0o21!#e%0b#w-9%4230t'
...
ROOT_URLCONF = 'hibroProducts.urls'
...
WSGI_APPLICATION = 'hibroProducts.wsgi.application'
